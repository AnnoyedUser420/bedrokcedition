...
public class ChunkProviderGenerate implements IChunkProvider {
        ...
        for(int var8 = 0; var8 < 16; ++var8) {
            for(int var9 = 0; var9 < 16; ++var9) {
                ...
                for(int var17 = 127; var17 >= 0; --var17) {
                    ...
                    if (var17 <= 0 + this.rand.nextInt(4)) {
    ...
    public Chunk provideChunk(int var1, int var2) {
        ...
        this.field_35386_d.generate(this, worldObj, var1, var2, var3);
        this.field_902_u.generate(this, this.worldObj, var1, var2, var3);
        field_35385_f.generate(this, worldObj, var1, var2, var3);
    ...
    private double[] func_4061_a(double[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
        ...
        double coordscale = 684.412D;
        Random makethesufferingend = new Random();
        ...
        this.field_4185_d = this.field_910_m.generateNoiseOctaves(this.field_4185_d, (double)var2, (double)var3, (double)var4, var5, var6, var7, coordscale / 80.0D, var10 / 160.0D, coordscale / 80.0D);
        this.field_4184_e = this.field_912_k.generateNoiseOctaves(this.field_4184_e, (double)var2, (double)var3, (double)var4, var5, var6, var7, coordscale, var10, coordscale);
        this.field_4183_f = this.field_911_l.generateNoiseOctaves(this.field_4183_f, (double)var2, (double)var3, (double)var4, var5, var6, var7, coordscale, var10, coordscale);
        int var14 = 0;
        int var15 = 0;
        int var16 = 16 / var5;
    ...
    public void populate(IChunkProvider var1, int var2, int var3) {
        ...
        int var14;
        int var15;
        field_35386_d.func_35629_a(worldObj, rand, var2, var3);
        field_35385_f.func_35629_a(worldObj, rand, var2, var3);
        ...
        for(var13 = 0; var13 < 20; ++var13) {
            ...
            var15 = this.rand.nextInt(128);
            var16 = var5 + this.rand.nextInt(16);
            (new WorldGenMinable(0, 32)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
