...
public class CraftingManager {
    ...
    private CraftingManager() {
        ...
        this.addRecipe(new ItemStack(Item.gunpowder, 999), "#", '#', Item.coal);
        ...
        this.addRecipe(new ItemStack(Block.fire, 1), "###", '#', Block.dirt);
        ...
        this.addRecipe(new ItemStack(Block.torchWood, 127), "#", "#", '#', Item.stick);
        ...
        this.addRecipe(new ItemStack(Block.cheekyendportal, 1), "##", "##", '#', Block.blockDiamond);
