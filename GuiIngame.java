...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
        ...
        if (this.mc.playerController.shouldDrawHUD()) {
            ...
            if(mc.thePlayer.isFlying)
            {
            	super.drawString(mc.fontRenderer, "Flying", 2, 2, 16777215);
            	if(mc.thePlayer.isFlying && mc.thePlayer.noClip)
            	{
            		super.drawString(mc.fontRenderer, "Noclip", 2, 11, 16777215);
            	}
            }
            else
            {
            ...
            if(mc.thePlayer.isFuckingImmortal)
            {
            	super.drawString(mc.fontRenderer, "Can't Die", 2, 20, 11141120);
            }
        }
