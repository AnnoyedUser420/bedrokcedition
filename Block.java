...
public class Block {
    ...
    public static final Block cheekyendportal;
    ...
    static {
        ...
        bedrock = (new Block(7, 17, Material.rock)).setHardness(Float.MAX_VALUE).setResistance(3.0F).setStepSound(soundStoneFootstep).setBlockName("bedrock").disableStats();
        ...
        netherrack = (new BlockNetherrack(87, 103)).setHardness(0.4F).setStepSound(soundStoneFootstep).setLightValue(1.0F).setBlockName("hellrock");
        ...
        field_35286_bo = (new BlockMushroomCap(99, Material.wood, 142, 0)).setHardness(0.2F).setStepSound(soundWoodFootstep).setBlockName("mushroom").disableNeighborNotifyOnMetadataChange();
        field_35287_bp = (new BlockMushroomCap(100, Material.wood, 142, 1)).setHardness(0.2F).setStepSound(soundWoodFootstep).setBlockName("mushroom").disableNeighborNotifyOnMetadataChange();
        ...
        field_35277_bw = (new BlockFenceGate(107, 4)).setHardness(2.0F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("fenceGate").disableNeighborNotifyOnMetadataChange();
        field_35280_bx = (new BlockStairs(108, brick)).setBlockName("stairsBrick").disableNeighborNotifyOnMetadataChange();
        field_35279_by = (new BlockStairs(109, field_35285_bn)).setBlockName("stairsStoneBrickSmooth").disableNeighborNotifyOnMetadataChange();
        cheekyendportal = (new BlockEndPortal(119, Material.portal)).setHardness(-1F).setResistance(6000000F);
        endstone = (new Block(121, 175, Material.rock)).setHardness(3F).setResistance(15F).setStepSound(soundStoneFootstep).setBlockName("whiteStone");
