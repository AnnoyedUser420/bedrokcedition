...
public abstract class Minecraft implements Runnable {
    ...
    private void clickMiddleMouseButton() {
        if (this.objectMouseOver != null) {
            ...
            this.thePlayer.inventory.setCurrentItem(var1, this.playerController instanceof PlayerController);
        }
    ...
    public void usePortal(int i)
    {
        ...
        if(thePlayer.dimension == 0)
        {
            ...
            {
                changeWorld(world1, "Leaving the Sky Dimension", thePlayer);
            }
        } else
        {
            World world2 = null;
            ...
            try {
                thePlayer.posY = chunkcoordinates.y;
            }
            catch(NullPointerException e)
            {
                thePlayer.posY = 64;
            ...
            changeWorld(world2, "Entering the Sky Dimension", thePlayer);
        }
    ...
    public void respawn(boolean var1, int var2) {
        if (!this.theWorld.multiplayerWorld && !this.theWorld.worldProvider.canRespawnHere()) {
            this.theWorld = new World(theWorld, WorldProvider.getProviderForDimension(0));
        }
