...
public class GuiIngameMenu extends GuiScreen {
    ...
    String splashText = "shitass edition";

    public void initGui() {
        this.updateCounter2 = 0;
        this.controlList.clear();
        byte var1 = -16;
        this.controlList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 120 + var1, "return to eternal suffering"));
        if (this.mc.isMultiplayerWorld()) {
            ((GuiButton)this.controlList.get(0)).displayString = "disconnect me daddy";
        }

        this.controlList.add(new GuiButton(4, this.width / 2 - 100, this.height / 4 + 24 + var1, "go back to playing scatcraft"));
        this.controlList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + var1, "change things"));
    ...
    public void drawScreen(int var1, int var2, float var3) {
        ...
        if (var4 || this.updateCounter < 20) {
            ...
            this.drawString(this.fontRenderer, "Torturing the souls of the damned", 8, this.height - 16, var6 << 16 | var6 << 8 | var6);
        }
        GL11.glPushMatrix();
