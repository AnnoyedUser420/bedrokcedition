...
public class GuiMainMenu extends GuiScreen {
	...
	public void initGui() {
        ...
        this.controlList.add(new GuiButton(1, this.width / 2 - 100, var4, "play by urself"));
        this.controlList.add(this.multiplayerButton = new GuiButton(2, this.width / 2 - 100, var4 + 24, "play with other souls"));
        this.controlList.add(new GuiButton(3, this.width / 2 - 100, var4 + 48, "replace game files"));
        if (this.mc.hideQuitButton) {
            this.controlList.add(new GuiButton(0, this.width / 2 - 100, var4 + 72, "change things"));
        } else {
            this.controlList.add(new GuiButton(0, this.width / 2 - 100, var4 + 72 + 12, 98, 20, "change things"));
            this.controlList.add(new GuiButton(4, this.width / 2 + 2, var4 + 72 + 12, 98, 20, "alt f4"));
        }
    ...
    public void drawScreen(int var1, int var2, float var3) {
        ...
        this.drawCenteredString(this.fontRenderer, "bedrokc edition", -64, -16, 16776960);
        GL11.glPopMatrix();
        this.drawString(this.fontRenderer, "awfulcraft B 1.7.3", 2, 2, 5263440);
