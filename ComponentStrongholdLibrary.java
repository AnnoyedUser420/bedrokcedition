...
public class ComponentStrongholdLibrary extends ComponentStronghold
{
    ...
    static 
    {
        field_35056_b = (new StructurePieceTreasure[] {
            new StructurePieceTreasure(Item.book.shiftedIndex, 0, 1, 3, 20), new StructurePieceTreasure(Item.paper.shiftedIndex, 0, 2, 7, 20), new StructurePieceTreasure(Item.compass.shiftedIndex, 0, 1, 1, 1)
        });
    }
}
